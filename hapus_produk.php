...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["kode"])) {
    ...
    $sql = "DELETE FROM tb_brg WHERE kode_brg = '$kode_brg'";

    if ($conn->query($sql) === TRUE) {
        header("Location: browseproduk.php"); // Redirect kembali ke halaman browseproduk.php setelah berhasil menghapus
        exit;
    } else {
...
<body>
    <div class="container mt-5">
        ...
        <form action="" method="POST" onsubmit="return confirmDelete();">
            ...
            <a href="browseproduk.php" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
</body>
